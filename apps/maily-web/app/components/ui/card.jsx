...
const Card = React.forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} className={(0, utils_1.cn)('rounded-lg border border-gray-200 bg-white text-gray-950 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50', className)} {...props}/>);
});
exports.Card = Card;
...
const CardDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<p ref={ref} className={(0, utils_1.cn)('text-sm text-gray-500 dark:text-gray-400', className)} {...props}/>);
});
