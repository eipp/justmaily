...
exports.PerformanceReportSchema =
  exports.ABTestAnalysisSchema =
  exports.CampaignAnalysisSchema =
  exports.AudienceSegmentSchema =
...
exports.CampaignAnalysisSchema = common_1.BaseEntitySchema.extend({
  ...
  timeSeriesData: zod_1.z.array(
    zod_1.z.object({
      timestamp: zod_1.z.string().datetime(),
      metrics: exports.MetricsSchema,
    }),
  ),
  insights: zod_1.z.array(
    zod_1.z.object({
