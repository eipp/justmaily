...
const { sendEmail, validateEmail, checkSpamScore, optimizeContent } = (0,
workflow_1.proxyActivities)({
  startToCloseTimeout: '1 minute',
});
const { recordMetrics, aggregateAnalytics, exportToGrafana } = (0,
workflow_1.proxyActivities)({
  startToCloseTimeout: '5 minutes',
});
const { runABTest, optimizeSchedule, predictDeliveryTime } = (0,
workflow_1.proxyActivities)({
...
async function campaignOptimizationWorkflow(campaign, analytics) {
  ...
  return Object.assign(Object.assign({}, campaign), {
    schedule: optimizedSchedule,
