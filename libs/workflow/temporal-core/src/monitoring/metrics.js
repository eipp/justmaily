...
exports.MetricsService = exports.matrixMessageCounter = exports.matrixEventCounter = exports.matrixLatencyHistogram = exports.aiErrorCounter = exports.aiPredictionLatencyHistogram = exports.aiCacheCounter = exports.queueSizeGauge = exports.systemErrorCounter = exports.variantPerformanceGauge = exports.abTestCounter = exports.providerLatencyGauge = exports.providerHealthGauge = exports.bounceRateGauge = exports.clickRateGauge = exports.openRateGauge = exports.deliveryLatencyHistogram = exports.emailSentCounter = void 0;
...
class MetricsService {
    constructor(meterProvider, config = {}) {
        ...
        this.defaultLabels = Object.assign({ version: config.version || 'unknown', environment: config.environment || 'development' }, config.defaultLabels);
    }
    ...
    async recordProviderLatency(provider, operation, latencyMs) {
        exports.providerLatencyGauge.labels(provider, operation).set(latencyMs / 1000);
    }
    ...
    async getCounter(name, options) {
        ...
        if (!this.counters.has(key)) {
            this.counters.set(key, this.meter.createCounter(name, {
    ...
    async getHistogram(name, options) {
        ...
        if (!this.histograms.has(key)) {
            this.histograms.set(key, this.meter.createHistogram(name, {
                description: options.description,
                unit: options.unit
            }));
        }
    ...
    async getGauge(name, options) {
        ...
        if (!this.gauges.has(key)) {
            this.gauges.set(key, this.meter.createObservableGauge(name, {
                description: options.description,
                unit: options.unit
            }));
        }
