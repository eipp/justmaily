...
class MatrixMessaging {
    constructor(config, metrics, security) {
        ...
        this.client = new matrix_bot_sdk_1.MatrixClient(config.homeserverUrl, config.accessToken, storage);
        if (config.autoJoin) {
    ...
    async connect() {
        try {
            ...
            await this.metrics.recordLatency('matrix_connect', Date.now() - startTime);
    ...
    async createRoom(name, options = {}) {
        try {
            ...
            const createOptions = {
                name,
                topic: options.topic,
                visibility: options.isPublic ? matrix_bot_sdk_1.RoomVisibility.Public : matrix_bot_sdk_1.RoomVisibility.Private,
    ...
    async setupEncryption() {
        var _a;
        if (!((_a = this.config.encryption) === null || _a === void 0 ? void 0 : _a.enabled))
            return;
        try {
        ...
        try {
            ...
            for (const roomId of joinedRooms) {
                ...
                this.rooms.set(roomId, {
                    name: ((_a = nameEvent === null || nameEvent === void 0 ? void 0 : nameEvent.content) === null || _a === void 0 ? void 0 : _a.name) || roomId,
                    topic: (_b = topicEvent === null || topicEvent === void 0 ? void 0 : topicEvent.content) === null || _b === void 0 ? void 0 : _b.topic,
                    memberCount: ((_c = membersEvent === null || membersEvent === void 0 ? void 0 : membersEvent.content) === null || _c === void 0 ? void 0 : _c.count) || 0,
    ...
    async prepareMessage(content, options) {
        ...
        if (options.replyTo) {
            messageContent['m.relates_to'] = Object.assign(Object.assign({}, messageContent['m.relates_to']), { 'm.in_reply_to': {
