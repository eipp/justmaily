...
class AnthropicClient extends BaseClient_1.BaseAIClient {
    ...
    async generateCompletion(prompt, options) {
        ...
        try {
            const response = await this.client.messages.create({
                ...
                top_p: (_b = options === null || options === void 0 ? void 0 : options.topP) !== null && _b !== void 0 ? _b : this.config.topP,
                stop_sequences: (_c = options === null || options === void 0 ? void 0 : options.stopSequences) !== null && _c !== void 0 ? _c : this.config.stopSequences
            });
            const metrics = await this.createMetrics(startTime, true, undefined, {
                prompt: (_d = response.usage) === null || _d === void 0 ? void 0 : _d.input_tokens,
                completion: (_e = response.usage) === null || _e === void 0 ? void 0 : _e.output_tokens
            });
            return {
    ...
    async analyzeImage(imageUrl, prompt) {
        ...
        try {
            ...
            const metrics = await this.createMetrics(startTime, true, undefined, {
                prompt: (_a = response.usage) === null || _a === void 0 ? void 0 : _a.input_tokens,
                completion: (_b = response.usage) === null || _b === void 0 ? void 0 : _b.output_tokens
            });
            return {
                data: response.content[0].text,
                usage: metrics,
