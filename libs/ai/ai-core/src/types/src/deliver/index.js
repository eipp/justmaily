...
exports.DeliveryReportSchema = exports.DeliveryTaskSchema = exports.CampaignSchema = exports.EmailTemplateSchema = void 0;
...
exports.DeliveryTaskSchema = common_1.BaseEntitySchema.extend({
    ...
    tracking: zod_1.z.object({
        opens: zod_1.z.array(zod_1.z.object({
            timestamp: zod_1.z.string().datetime(),
            ipAddress: zod_1.z.string().optional(),
            userAgent: zod_1.z.string().optional()
        })).optional(),
        clicks: zod_1.z.array(zod_1.z.object({
            timestamp: zod_1.z.string().datetime(),
            url: zod_1.z.string(),
            ipAddress: zod_1.z.string().optional(),
            userAgent: zod_1.z.string().optional()
