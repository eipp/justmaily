...
exports.TrendsRequestSchema = exports.CompetitorsRequestSchema = exports.NewsRequestSchema = exports.ScrapeOptionsSchema = exports.BatchEnrichContactsSchema = exports.EnrichContactSchema = exports.SearchOptionsSchema = exports.DateRangeSchema = exports.PaginationSchema = void 0;
...
exports.BatchEnrichContactsSchema = zod_1.z.object({
    body: zod_1.z.object({
        contacts: zod_1.z.array(exports.EnrichContactSchema.shape.body)
            .min(1)
            .max(100)
    })
});
...
exports.NewsRequestSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        options: zod_1.z.object({
            limit: zod_1.z.number().int().min(1).max(100).optional(),
            recency: zod_1.z.enum(['day', 'week', 'month', 'year']).optional(),
            categories: zod_1.z.array(zod_1.z.enum(['news', 'press_release', 'blog'])).optional()
        }).optional()
    })
});
